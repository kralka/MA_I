...
\begin{itemize}
    ...
    \item[(d)] $\underset{n\rightarrow\infty}{\lim}\frac{2^{100}n}{n^{2}+1},$ 
		...
		\item[(i)] $\underset{n\rightarrow\infty}{\lim}\left(\sqrt{n+1}-\sqrt n\right),$ 
			\solution{
				Vhodně rozšíříme pomocí vzorce $a^{2}-b^{2}=(a+b)(a-b)$, kde $a=\sqrt{n+1}$ a $b=\sqrt{n}$. Upravíme, čitatel i jmenovatel vynásobíme $\frac{1}{\sqrt{n}}$ a dopočteme použitím VOAL a VOLO pro $\frac{1}{\sqrt{n}}\rightarrow0$ a $\sqrt{1+\frac{1}{n}}\rightarrow0$.
